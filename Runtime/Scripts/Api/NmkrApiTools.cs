...
namespace Nmkr.Sdk
{
    public static partial class Api
    {
        ...
        public static async Task<ApiResponse<AssetsAssociatedWithAccount[]>> GetAllAssetsInWallet(string address, Action<AssetsAssociatedWithAccount[]> onSuccess = null, Action<ResponseError> onFailure = null)
        {
